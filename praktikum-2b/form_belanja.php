...
<head>
    ...
    <style>
        .harga-container {
            ...
            padding: 20px;
            border-radius: 5px;
            background-color:rgb(195, 238, 210);
        }
        .harga-container h4 {
            margin-bottom: 20px;
        }
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form method="POST" action="total_belanja.php">
                    <fieldset class="border border-dark p-3 rounded" style="background-color: lavender;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input id="namacus" name="namacus" placeholder="*Meila Ayu" type="text" required="required" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
